DROP TABLE relacao_pessoas_acidente_transito;
CREATE EXTERNAL TABLE IF NOT EXISTS relacao_pessoas_acidente_transito (
	num_boletim 			String,
...
STORED AS TEXTFILE
location '/user/vagrant/trabalhoBigData/pessoaAcidente/';