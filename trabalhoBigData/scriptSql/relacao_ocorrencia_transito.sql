DROP TABLE relacao_ocorrencia_transito;
CREATE EXTERNAL TABLE IF NOT EXISTS relacao_ocorrencia_transito (
	n_boletim				String,
...
STORED AS TEXTFILE
location '/user/vagrant/trabalhoBigData/ocorrenciaTransito/';